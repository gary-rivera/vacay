function findBox(capacity: number[], itemSize: number): number {
...
/*
question: You are given an integer array capacity, where capacity[i] represents the capacity of the ith box, and an integer itemSize representing the size of an item.
