...
function distanceLimitedPathsExist(n: number, edgeList: Edge[], queries: Query[]): boolean[] {
    ...
    for (let [p, q, limit, index] of sortedQueries) {
        while (i < sortedEdges.length && sortedEdges[i][2] < limit) {
